...
namespace Timereporting.Api.Services.Seeding
{
        ...
        where TIdentityRole : IdentityRole, new()
    {
        ...
        private const string DefaultAdminUserEmail = "admin@consat.se";
        private const string DefaultAdminUserPassword = "ConsatPass123";
        ...
        {
            var user = await userManager.FindByEmailAsync("admin@consat.se");
            if (user == null)
            {
