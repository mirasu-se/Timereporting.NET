...
{
    public class AppHostedSeedingService : IHostedService
    {
        private readonly IServiceProvider _services;
        private readonly ILogger<AppHostedSeedingService> _logger;
        private CancellationTokenSource? _cancellationTokenSource;

        public AppHostedSeedingService(IServiceProvider services, ILogger<AppHostedSeedingService> logger)
        {
            _services = services;
            _logger = logger;
        }
