...
using System.Text;
using Timereporting.UI.Features.TagHelpers.Metadata.Providers;

namespace Timereporting.UI.Features.TagHelpers.Metadata.Services
{
    public class MetadataTagBuildingService : TagHelperComponent
    {
        ...
        {
            string manifestUrl = MetadataProvider.GetAppMetadata().ApplicatioManifestUrl.ToString();
        ...
        {
            string appTitle = MetadataProvider.GetOpenGraphDefaultData().Title.ToString();
        ...
        public static string GenerateApplicationMetaTags()
        {
            ...
            var applicationMetadata = MetadataProvider.GetAppMetadata();
            metaString.Append(
        ...
        {
            StringBuilder metaString = new();
            var appleIcons = MetadataProvider.GetAppleIcons();
        ...
        {
            StringBuilder metaString = new();
            var androidIcons = MetadataProvider.GetFavicons();
        ...
        {
            StringBuilder metaString = new();
            var openGraphDefaultData = MetadataProvider.GetOpenGraphDefaultData();
            metaString.Append(
        ...
        {
            StringBuilder metaString = new();
            var openGraphTwitterData = MetadataProvider.GetOpenGraphTwitterData();
            metaString.Append(
