...
$('#image-preview').on('click', new _infrastructure_filesystem_imageProcessing__WEBPACK_IMPORTED_MODULE_1__["default"]().openImageFileDialog);
$('#image-input').on('change', new _infrastructure_filesystem_imageProcessing__WEBPACK_IMPORTED_MODULE_1__["default"]().previewImage);
