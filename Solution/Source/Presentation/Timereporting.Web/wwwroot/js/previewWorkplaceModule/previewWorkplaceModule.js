...
/* harmony import */ var _timereporting_api_presenters_trinaxWorkplaceDataPresenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../timereporting.api/presenters/trinaxWorkplaceDataPresenter */ "./source/js/presentation/timereporting.api/presenters/trinaxWorkplaceDataPresenter.js");
/* harmony import */ var _timereporting_api_presenters_fallbackWorkplaceDataPresenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../timereporting.api/presenters/fallbackWorkplaceDataPresenter */ "./source/js/presentation/timereporting.api/presenters/fallbackWorkplaceDataPresenter.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "jquery");
﻿
...
async function getWorkplaces() {
  ...
  try {
    ...
    if (getApiEndpoint() === _application_appConfig__WEBPACK_IMPORTED_MODULE_0__["default"].getApiBaseUrl()) {
      const trinaxDataPresenter = new _timereporting_api_presenters_trinaxWorkplaceDataPresenter__WEBPACK_IMPORTED_MODULE_2__["default"]();
        ...
        const fallbackDataPresenter = new _timereporting_api_presenters_fallbackWorkplaceDataPresenter__WEBPACK_IMPORTED_MODULE_3__["default"]();
